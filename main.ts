...
namespace matubara_blocks {
 ...
 //% weight=30 block="腕をふる角度が |%limit| 度より大きく" group="体育"
 ...
 //% weight=6 block="腕をふる角度が |%limit| 度より小きく" group="体育"
 //% limit.min=0 limit.max=90
